...
contract RecursiveTypeTester {
    ...
    function testDynamicPrimitives(
        WithDynamicPrimitives memory s
    ) external pure returns (uint256) {
    ...
    function testFixedStructArray(
        WithFixedStructArray memory s
    ) external pure returns (uint256) {
        return s.inners[0].x;
    }
    ...
    function testFixedStructArray3(
        WithFixedStructArray3 memory s
    ) external pure returns (uint256) {
        return s.inners[0].x;
    }
