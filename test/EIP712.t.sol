...
contract EIP712Proxy {
    ...
    constructor(EIP712TestContract implementation) {
...
contract EIP712Test is Test {
    ...
    function setUp() public {
        ...
        string memory longName = "This is a very long name that exceeds the ShortString limit and will require fallback storage in the contract implementation";
        string memory longVersion = "1.0.0-alpha+ThisIsAVeryLongVersionStringThatExceedsTheShortStringLimitAndWillRequireFallbackStorage";
    ...
    function test_longNameFallback() public {
        ...
        (
            ...
            ,
            ,
        ) = eip712LongName.eip712Domain();
        
        // Verify returned name and version use fallback
        assertEq(returnedName, longName);
        assertEq(returnedVersion, "1.0.0-alpha+ThisIsAVeryLongVersionStringThatExceedsTheShortStringLimitAndWillRequireFallbackStorage");
    }
    ...
    function test_directEIP712Name() public {
        ...
        assertEq(longName, "This is a very long name that exceeds the ShortString limit and will require fallback storage in the contract implementation");
    }
    ...
    function test_directEIP712Version() public {
        ...
        assertEq(longVersion, "1.0.0-alpha+ThisIsAVeryLongVersionStringThatExceedsTheShortStringLimitAndWillRequireFallbackStorage");
    }
    ...
    function test_domainSeparatorThroughProxy() public {
        ...
        (bool success, bytes memory data) = address(proxy).staticcall(
            abi.encodeWithSignature("domainSeparatorV4()")
        );
        ...
        (success, data) = address(proxy).staticcall(
            abi.encodeWithSignature("hashTypedDataV4(bytes32)", testStruct)
        );
        require(success, "Call failed");
